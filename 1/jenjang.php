    ...
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
			        ...
			        <li class="active"><a href="jenjang.php"><i class="fa fa-graduation-cap"></i><span>Jenjang</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-graduation-cap"></i> Jenjang</li>
          </ol>
        </section>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="jenjang_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
							<div class="form-group">
								<label>Kode Jenjang</label>
									<div class="input-group">
										...
										<input name="Kode_Jenjang" type="text" class="form-control" placeholder="Kode Jenjang"/>
									</div>
							</div>
							<div class="form-group">
								<label>Jenjang</label>
									<div class="input-group">
										...
										<input name="Nama_Jenjang" type="text" class="form-control" placeholder="Jenjang"/>
									</div>
							</div>
		...
		<div id="ModalEditJenjang" class="modal fade" tabindex="-1" role="dialog"></div>
